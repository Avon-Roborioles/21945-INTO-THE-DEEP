...
public class SimPoseStorage {
   ...
   public static Pose2d RightSample1 = new Pose2d(43,-12,Math.toRadians(180));
   ...
   public static Pose2d SampleDropoff = new Pose2d(54,-49,Math.toRadians(180));

   public static Pose2d SpecimenPickup = new Pose2d(50,-57,Math.toRadians(90));

   public static Pose2d SpecimenScore = new Pose2d(0,-36,Math.toRadians(-90));
