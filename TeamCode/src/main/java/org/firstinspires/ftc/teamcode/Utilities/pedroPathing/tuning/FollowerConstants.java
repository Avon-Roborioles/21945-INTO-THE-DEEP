package org.firstinspires.ftc.teamcode.Utilities.pedroPathing.tuning;
...
import org.firstinspires.ftc.teamcode.Utilities.pedroPathing.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.Utilities.pedroPathing.util.CustomPIDFCoefficients;
import org.firstinspires.ftc.teamcode.Utilities.pedroPathing.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    public static double mass = 12.05; //comp #2 mass

    // Centripetal force to power scaling
    public static double centripetalScaling = 0.0000008; //try 0.0005


    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double forwardZeroPowerAcceleration = -52.4395211; //try -31.0466


    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -76.6931786; //try -66.0001
